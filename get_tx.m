...
% wektory pionowe
% In:
%   tau: chwile czasu dla przełączeń sterowania
%   u: sterowania w przedziałąch czasu
%   x0: war. początkowee
%   MDNS: liczba kroków na sekundę
% Out:
%   t: wektor czasu
%   x: stany w czasie
%   uk: sterowanie w czasie
%   nseg: momenty zmiany sterowania
